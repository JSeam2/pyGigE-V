### PyGigE-V
_NOTE_ This library may not be suited for real time video streaming, performance issues and the occasional segfault might occur. An alternative approach is to use some kind of Inter-process communication like pipes to have a C++ program communicate with a Python program. An example can be found in [Python-Cpp-IPC-for-Gigev](https://github.com/JSeam2/Python-Cpp-IPC-for-Gigev)
